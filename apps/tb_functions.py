...
#
#         cmds.addAttr(mainControl, longName='LineWidth', attributeType='float', defaultValue=scale, minValue=-1, maxValue=10)
...
#                 rgbColour = [x * 255 for x in cmds.colorIndex(cmds.getAttr(refObj + '.overrideColor'), q=True)]
#         else:
#             rgbColour = [x * 255 for x in cmds.setAttr(refObj +'.overrideColorRGB')]
...
#         keyTimes = []
#         if animLayer:
#             animLayer = cmds.PyNode(animLayer)
#
#         if allLayers:
...
#         selection = [cmds.PyNode(x) for x in selection]
#         parentDict = {}
#         for x in selection:
...
#         constraint = cmds.PyNode(constraint)
